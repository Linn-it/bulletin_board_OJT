...
<div class="container mx-auto">
    ...
    <div class="w-72 md:w-96 bg-white border mt-12 mx-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div class="flex flex-col pb-7 px-4">
          ...
          <h5 class="mb-2 text-md font-medium text-gray-600 dark:text-white"><span class="text-red-400">Title :</span> {{$post['title']}}</h5>
          <span class="mb-2 text-md font-medium text-gray-600 dark:text-white"><span class="text-red-400">Description :</span> {{$post['description']}}</span>
          <span class="mb-2 text-md font-medium text-gray-600 dark:text-white"><span class="text-red-400">Status :</span> {{$post['status'] == 1 ? 'Active' : 'Inactive'}}</span>
          <span class="mb-2 text-md font-medium text-gray-600 dark:text-white"><span class="text-red-400">Posted User : </span>{{$post['user']['name']}}</span>
          <span class="text-md font-medium text-gray-600 dark:text-white"><span class="text-red-400">Posted Date :</span> {{$post['created_at']->format('Y-m-d')}}</span>
      </div>
