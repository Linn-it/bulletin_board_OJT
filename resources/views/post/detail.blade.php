...
<div class="container mx-auto">
    ...
    <div class="w-72 md:w-80 bg-white border mt-12 mx-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div class="flex flex-col items-center pb-7">
          ...
          <h5 class="mb-1 text-xl font-medium text-gray-600 dark:text-white">title - {{$post['title']}}</h5>
          <span class="mb-1 text-md font-medium text-gray-600 dark:text-white">description - {{$post['description']}}</span>
          <span class="mb-1 text-md font-medium text-gray-600 dark:text-white">status - {{$post['status'] == 1 ? 'Active' : 'Inactive'}}</span>
          <span class="mb-1 text-md font-medium text-gray-600 dark:text-white">posted user - {{$post['user']['name']}}</span>
